...
export default function AllocationChart({ holdings }: Props) {
  ...
  return (
    <div className="rounded-2xl bg-zinc-900 dark:bg-zinc-900 light:bg-gray-50 border border-zinc-800 dark:border-zinc-800 light:border-gray-200 p-4 mb-5">
      <h3 className="text-zinc-400 text-xs uppercase tracking-wider mb-3">Allocation</h3>
        ...
        <PieChart>
          ...
          <Tooltip
            formatter={(value) => {
              ...
              return [`$${num.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, "Value"] as [string, string];
            }}
          ...
          <Legend
            ...
            formatter={(value: string, entry: any) => {
              ...
              const pct = typeof val === "number" ? ((val / totalValue) * 100).toFixed(1) : "0.0";
              return <span style={{ color: "#a1a1aa", fontSize: 11 }}>{value} {pct}%</span>;
            }}
          />
        </PieChart>
      </ResponsiveContainer>
